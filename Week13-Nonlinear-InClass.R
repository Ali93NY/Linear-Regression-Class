...
# Bootstrap CI:
# There are many versions of boostrap confidence intervals
...
# the MSE is big, the goal is to beast MSE.
...
n <- names(train_)
f <- as.formula(paste("medv ~", paste(n[!n %in% "medv"], collapse = " + "))) # very important this code 
