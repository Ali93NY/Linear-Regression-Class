# Example for material so far:

# We will use a built-in dataset:
...
# a) Report the regression line:
# y.hat = -1.874 + 0.0756*x

# b) Find the correlation between waiting time and eruption time
...
# p-value = 0, therefore reject H0
# That is, beta1 is not zero
# That is, beta1 is significant (regression model is significant)
