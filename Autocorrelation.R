...
rho3 = numerator/sum(r2[2:n]^2)
rho3

Yprime = 1:n
for (i in 2:n) Yprime[i] = Y[i]-0.527*Y[i-1]
Yprime = Yprime[-1]

Xprime = 1:n
for (i in 2:n) Xprime[i] = X[i]-0.527*X[i-1]
Xprime = Xprime[-1]
...
# SE(b0)
summary(Regprime2)$coef[1,2]/(1-0.527)
